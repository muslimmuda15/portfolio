      ...
      <div className="absolute top-8 right-8 z-20 flex items-center gap-4">
        ...
        <button
          ...
          className={`w-10 h-10 md:w-12 md:h-12 rounded-full 
            ...
            border border-gray-200 dark:border-white/20 shadow-lg 
        ...
        <Image
          ...
          className={`w-10 h-10 md:w-12 md:h-12 rounded-full object-cover 
            border-2 border-gray-300 dark:border-white/30 shadow-lg 
      ...
      <div className="relative z-10 w-full max-w-200 flex flex-col items-center gap-4 pb-4">
          ...
          {navigationButtons.map((button) => (
            <button
              ...
              className={`flex-1 px-3 py-2.5 text-sm font-medium rounded-lg 
                ...
                hover:border-blue-300 dark:hover:border-blue-400/30 active:scale-95 
        ...
        >
          <input
            ...
            disabled={isLoading}
            className={`w-full px-6 py-4 pr-14 text-base 
              bg-white dark:bg-white/5 backdrop-blur-sm 
              rounded-full border border-gray-300 dark:border-white/10 
              text-gray-900 dark:text-white 
          ...
          <button
            ...
            className={`absolute right-2 top-1/2 -translate-y-1/2 
              ...
              bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-400 dark:to-cyan-400 
              flex items-center justify-center 
              transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95 
